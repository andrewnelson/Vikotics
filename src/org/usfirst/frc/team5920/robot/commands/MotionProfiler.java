...
import org.usfirst.frc.team5920.robot.Instrumentation;
...
public class MotionProfiler {
	 ...
	 */
	public MotionProfiler(TalonSRX talon) {
		_talon = talon;
		/*
	...
	private void startFilling() {
		...
		startFilling(SimpleMotionProfile.Points, SimpleMotionProfile.kNumPoints);
	}
	...
	private void startFilling(double[][] profile, int totalCnt) {
		...
		for (int i = 0; i < totalCnt; ++i) {
			...
			point.position = positionRot * RobotMap.kSensorUnitsPerRotation; //Convert Revolutions to Units
			point.velocity = velocityRPM * RobotMap.kSensorUnitsPerRotation / 600.0; //Convert RPM to Units/100ms
